<template>
  <div class="book">
    <div class="page">
      &nbsp;
      <img class="page-img" src="~/assets/module1/page1/1.png">
    ...
    <div class="page page3">
      &nbsp;
      <img class="page-img" src="~/assets/module1/page1/3.png">
      <div class="right-page">
        <img src="~/assets/module1/page1/right-page.png">
    ...
    <div class="page">
      &nbsp;
      <img class="page-img" src="~/assets/module1/page1/4.png">
      <div class="left-page">
        <img src="~/assets/module1/page1/left-page.png">
    ...
    <div class="page page5">
      ...
      <img v-if="data.diseaseType === 'GENE_SUBHEALTH'" class="page-img"
           src="~/assets/module1/page1/5-1.png">
      <img v-if="data.diseaseType === 'GENE'" class="page-img"
           src="~/assets/module1/page1/5-2.png">
      <img v-if="data.diseaseType === 'SUBHEALTH'" class="page-img"
           src="~/assets/module1/page1/5-3.png">
      ...
      <div v-if="data.diseaseType === 'GENE_SUBHEALTH' || data.diseaseType === 'GENE'">
        <div class="gene-risk-box1 box" v-if="data.geneRisk1.length > 0">
          <div class="item" v-for="(item, index) in data.geneRisk1">
            <div class="dot-box">
              <img src="~/assets/module1/page1/dot.png">
    ...
    <div class="page page7" v-for="(jzexamAdvicePrjGroupVoList,index) of data.jzexamAdvicePrjGroupVoListGroup">
      &nbsp;
      <img class="page-img" src="~/assets/module1/page1/7.png">
    ...
    <div class="page">
      &nbsp;
      <img class="page-img" src="~/assets/module1/page1/8.png">
      <div class="right-page">
        <img src="~/assets/module1/page1/right-page.png">
    ...
    <div class="page">
      &nbsp;
      <img class="page-img" src="~/assets/module1/page1/9.png">
      <div class="left-page">
        <img src="~/assets/module1/page1/left-page.png">
    ...
    <div class="page">
      &nbsp;
      <img class="page-img" src="~/assets/module1/page1/10.png">
      <div class="right-page">
        <img src="~/assets/module1/page1/right-page.png">
    ...
    <div class="page">
      &nbsp;
      <img class="page-img" src="~/assets/module1/page1/12.png">
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    async fetch({store, route}) {
      await store.dispatch('module1-page1/GET_DATA', route.params.id);
    },
    computed: {
      ...mapState('module1-page1', {
